...
public class SpinnerActivity extends Activity {
     ...
     * is the best place to restore state. Attempts to read the state from a
     * preferences file. If this read fails, assume it was just installed, so do
     * an initialization. Regardless, change the state of the spinner to be the
     * previous position.
     * 
     ...
     * place to save state. Attempt to write the state to the preferences file.
